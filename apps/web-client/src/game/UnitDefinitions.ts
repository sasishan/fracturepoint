...
export interface UnitProductionDef {
  ...
  foodUpkeep:        number;
  /** Per-turn energy upkeep */
  energyUpkeep:      number;
  /** Per-turn rare earth upkeep */
  rareEarthUpkeep:   number;
  ...
  /** Tactical role label */
  role:              string;
  /** Special combat bonus description (shown in UI) */
  combatBonus?:      string;
...
export const UNIT_DEF: Record<UnitType, UnitProductionDef> = {
  ...
  infantry: {
    ...
    maintenanceCost: 1, oilUpkeep: 0, foodUpkeep: 1, energyUpkeep: 0, rareEarthUpkeep: 0,
  ...
  reserves: {
    ...
    requiredBuilding: 'barracks',
    maintenanceCost: 0, oilUpkeep: 0, foodUpkeep: 1, energyUpkeep: 0, rareEarthUpkeep: 0,
  ...
  special_forces: {
    ...
    requiredBuilding: 'barracks',
    maintenanceCost: 3, oilUpkeep: 1, foodUpkeep: 1, energyUpkeep: 0, rareEarthUpkeep: 0,
  ...
  engineers: {
    ...
    requiredBuilding: 'barracks',
    maintenanceCost: 1, oilUpkeep: 1, foodUpkeep: 1, energyUpkeep: 0, rareEarthUpkeep: 0,
  ...
  logistics: {
    ...
    requiredBuilding: 'barracks',
    maintenanceCost: 1, oilUpkeep: 2, foodUpkeep: 1, energyUpkeep: 0, rareEarthUpkeep: 0,
  ...
  tank: {
    ...
    maintenanceCost: 2, oilUpkeep: 3, foodUpkeep: 0, energyUpkeep: 0, rareEarthUpkeep: 0,
  ...
  artillery: {
    ...
    requiredBuilding: 'tank_factory',
    maintenanceCost: 2, oilUpkeep: 2, foodUpkeep: 0, energyUpkeep: 0, rareEarthUpkeep: 0,
    startStrength: 85, attack: 95, defense: 50,
    role: 'Fire Support',
    combatBonus: '+25% vs land units',
  },
  multi_launcher: {
    ...
    maintenanceCost: 2, oilUpkeep: 2, foodUpkeep: 0, energyUpkeep: 0, rareEarthUpkeep: 1,
    startStrength: 85, attack: 90, defense: 50,
    role: 'Area Denial',
    combatBonus: 'Splash damage — hits multiple targets',
  },
  air_defense: {
    type: 'air_defense', buildCost: 18, buildTime: 2,
    manpowerCost: 4, oilCost: 2, foodCost: 1, rareEarthCost: 3,
    requiredBuilding: 'missile_facility',
    maintenanceCost: 2, oilUpkeep: 1, foodUpkeep: 0, energyUpkeep: 0, rareEarthUpkeep: 1,
    startStrength: 88, attack: 80, defense: 75,
    role: 'Anti-Air Defense',
    combatBonus: '+50% vs aircraft',
  },
  launcher: {
    type: 'launcher', buildCost: 25, buildTime: 3,
    manpowerCost: 3, oilCost: 3, foodCost: 1, rareEarthCost: 4,
    requiredBuilding: 'missile_facility',
    maintenanceCost: 3, oilUpkeep: 1, foodUpkeep: 0, energyUpkeep: 0, rareEarthUpkeep: 1,
  ...
  stealth_fighter: {
    ...
    maintenanceCost: 5, oilUpkeep: 5, foodUpkeep: 0, energyUpkeep: 2, rareEarthUpkeep: 2,
    startStrength: 95, attack: 95, defense: 80,
    role: 'Air Superiority',
    combatBonus: '+25% vs aircraft',
  },
  bomber: {
    type: 'bomber', buildCost: 35, buildTime: 3,
    manpowerCost: 3, oilCost: 10, foodCost: 1, rareEarthCost: 3,
    requiredBuilding: 'air_base',
    maintenanceCost: 4, oilUpkeep: 7, foodUpkeep: 0, energyUpkeep: 2, rareEarthUpkeep: 0,
    startStrength: 90, attack: 85, defense: 60,
    role: 'Strategic Bombing',
    combatBonus: '+25% vs buildings',
  },
  helicopter: {
    type: 'helicopter', buildCost: 20, buildTime: 2,
    manpowerCost: 2, oilCost: 5, foodCost: 1, rareEarthCost: 2,
    requiredBuilding: 'air_base',
    maintenanceCost: 3, oilUpkeep: 3, foodUpkeep: 0, energyUpkeep: 1, rareEarthUpkeep: 0,
    startStrength: 85, attack: 80, defense: 65,
    role: 'Close Air Support',
    combatBonus: '+15% vs infantry',
  },
  transport_heli: {
    type: 'transport_heli', buildCost: 15, buildTime: 2,
    manpowerCost: 2, oilCost: 4, foodCost: 1, rareEarthCost: 1,
    requiredBuilding: 'air_base',
    maintenanceCost: 2, oilUpkeep: 3, foodUpkeep: 0, energyUpkeep: 1, rareEarthUpkeep: 0,
    startStrength: 75, attack: 10, defense: 40,
  ...
  combat_drone: {
    ...
    maintenanceCost: 2, oilUpkeep: 2, foodUpkeep: 0, energyUpkeep: 1, rareEarthUpkeep: 1,
    startStrength: 80, attack: 85, defense: 55,
    role: 'Precision Strike',
    specialAbility: 'Ignores fortification bonus',
  },
  recon_drone: {
    type: 'recon_drone', buildCost: 12, buildTime: 1,
    manpowerCost: 1, oilCost: 2, foodCost: 0, rareEarthCost: 2,
    requiredBuilding: 'drone_factory',
    maintenanceCost: 1, oilUpkeep: 1, foodUpkeep: 0, energyUpkeep: 1, rareEarthUpkeep: 1,
    startStrength: 70, attack: 5, defense: 40,
    role: 'Reconnaissance',
  },
  // ── Naval ─────────────────────────────────────────────────────────────────
  destroyer: {
    ...
    maintenanceCost: 4, oilUpkeep: 5, foodUpkeep: 1, energyUpkeep: 1, rareEarthUpkeep: 0,
    startStrength: 90, attack: 85, defense: 80,
    role: 'Anti-Submarine',
    combatBonus: '+50% vs submarines',
  },
  warship: {
    type: 'warship', buildCost: 25, buildTime: 3,
    manpowerCost: 8, oilCost: 10, foodCost: 4, rareEarthCost: 2,
    requiredBuilding: 'naval_base',
    maintenanceCost: 3, oilUpkeep: 6, foodUpkeep: 1, energyUpkeep: 0, rareEarthUpkeep: 0,
    startStrength: 85, attack: 80, defense: 75,
    role: 'Anti-Surface',
    combatBonus: '+25% vs surface vessels',
  },
  nuclear_sub: {
    type: 'nuclear_sub', buildCost: 55, buildTime: 5,
    manpowerCost: 4, oilCost: 6, foodCost: 3, rareEarthCost: 8,
    requiredBuilding: 'naval_base',
    maintenanceCost: 7, oilUpkeep: 4, foodUpkeep: 1, energyUpkeep: 1, rareEarthUpkeep: 0,
    startStrength: 95, attack: 95, defense: 90,
    role: 'Stealth Strike',
    specialAbility: 'Hidden from enemy detection until attacking',
  },
  carrier: {
    type: 'carrier', buildCost: 80, buildTime: 6,
    manpowerCost: 20, oilCost: 15, foodCost: 8, rareEarthCost: 10,
    requiredBuilding: 'naval_base',
    maintenanceCost: 10, oilUpkeep: 10, foodUpkeep: 3, energyUpkeep: 3, rareEarthUpkeep: 0,
    startStrength: 95, attack: 70, defense: 75,
    role: 'Air Projection',
    specialAbility: 'Extends air unit operational range',
  },
  assault_ship: {
    type: 'assault_ship', buildCost: 45, buildTime: 4,
    manpowerCost: 15, oilCost: 10, foodCost: 6, rareEarthCost: 4,
    requiredBuilding: 'naval_base',
    maintenanceCost: 6, oilUpkeep: 7, foodUpkeep: 2, energyUpkeep: 0, rareEarthUpkeep: 0,
    startStrength: 88, attack: 60, defense: 70,
    role: 'Amphibious Assault',
    specialAbility: 'Can land infantry on coastal provinces',
  },
};
